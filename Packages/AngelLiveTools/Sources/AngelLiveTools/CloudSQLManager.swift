...
public class CloudSQLManager: NSObject {
    
    public class func saveRecord(liveModel: LiveModel) async throws {
    ...
    public class func searchRecord(roomId: String) async throws -> [LiveModel] {
    ...
    public class func searchRecord() async throws -> [LiveModel] {
        let container = CKContainer(identifier: ck_identifier)
        let database = container.privateCloudDatabase
    ...
    public class func deleteRecord(liveModel: LiveModel) async throws {
    ...
    public class func getCloudState() async -> String {
        do {
