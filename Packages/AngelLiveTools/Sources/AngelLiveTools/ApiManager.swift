...
public class ApiManager {
    /**
     ...
     - Returns: 直播状态
    */
    public class func getCurrentRoomLiveState(roomId: String, userId: String?, liveType: LiveType) async throws -> LiveState {
        switch liveType {
            case .bilibili:
    ...
    public class func fetchRoomList(liveCategory: LiveCategoryModel, page: Int, liveType: LiveType) async throws -> [LiveModel] {
        switch liveType {
            case .bilibili:
    ...
    public class func fetchCategoryList(liveType: LiveType) async throws -> [LiveMainListModel] {
        switch liveType {
            case .bilibili:
    ...
    public class func fetchLastestLiveInfo(liveModel: LiveModel) async throws -> LiveModel {
